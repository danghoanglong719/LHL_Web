                    ...
                    <ul class="navbar-nav ">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="#"><span></span>SOFA</a>
                                <a class="dropdown-item" href="#"><span></span>CHAIR</a>
                                <a class="dropdown-item" href="#"><span></span>LAMP</a>
                                <a class="dropdown-item" href="#"><span></span>TABLE</a>
                            </div>
                        </li>
                    ...
                    <div class="box-muc">
                        ...
                        <div class="collapse show" id="collapseExample1">
                            <div class="box-muc2">
                                <div class="box-item">
                                    <label>
                                <input  type="radio" value="product_type:nội thất phòng tắm" value="all" class=" btn" id="all"name="sp">
                                <span> TẤT CẢ</span>
                            </label>
                                </div>
                                <div class="box-item">
                                    <label>
                                <input  type="radio" value="product_type:nội thất phòng tắm" value="SOFA" class=" btn" id="sofa"name="sp" v-model="picked">
                                <span> SOFA</span>
                            </label>
                                </div>
                                <div class="box-item">
                                    <label>
                                <input  type="radio" value="product_type:phòng ngủ" value="CHAIR" class=" btn" id="chair"name="sp">
                                <span> CHAIR</span>
                            </label>
                                </div>
                                <div class="box-item">
                                    <label>
                                <input  type="radio" value="product_type:nội thất văn phòng" value="LAMP"class=" btn" id="lamp"name="sp">
                                <span> LAMP</span>
                            </label>
                                </div>
                                <div class="box-item">
                                    <label>
                                <input  type="radio" value="product_type:nội thất phòng khách " value="TABLE" class=" btn" id="table" name="sp">
                                <span>TABLE</span>
                            </label>
                                </div>
                            </div>
