...
<?php
    ...
    if(isset($_POST['create']) )
    {
        ...
        $MoTa = $_POST['MoTa'];
        $Hinh = $_POST['image'];
        $sql = "INSERT INTO `sanpham`(`MaSP` ,`MaLoai`, `TenSanPham`, `GiaBan`, `MauSac`, `VatLieu`, `MoTa`, `Hinh`) VALUES ('$MaSP','$MaLoai', '$TenSanPham', '$GiaBan',' $MauSac','$VatLieu', ' $MoTa' ,'$Hinh' )";
                    ...
                    <form class="form-container" id="formLogin" method="POST">
                            ...
                            <div class="form-inline">
                                <div class="col-sm-12">
                                    <div class="form-inline">
                                        ...
                                        <input type="text" name="MaSP" id="ipFirstname" class="form-control col-sm-9"  >
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-inline">
                                ...
                                <input type="text" name="ID"  class="form-control col-sm-8" >
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-inline">
